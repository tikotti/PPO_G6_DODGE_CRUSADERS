...
public:
    ...
    void retranslateUi(QDialog *game)
    {
        ...
        pushButton_3->setText(QCoreApplication::translate("game", "Right", nullptr));
        pushButton_4->setText(QCoreApplication::translate("game", "Left", nullptr));
        Asteroide->setText(QString());
        Asteroide1->setText(QString());
        Asteroide2->setText(QString());
        BackGroundGame->setText(QString());
        lbl_Score->setText(QCoreApplication::translate("game", "Score :", nullptr));
    } // retranslateUi
